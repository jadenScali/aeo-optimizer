    ...
    <s-page heading="Generate llms.txt">
      {stage === "options" && (
        <s-section heading="What to include">
          <s-paragraph>
            ...
            <s-text>llms.txt</s-text>. AI answer engines will use this file to
            discover and cite the pages you select.
          </s-paragraph>
      ...
      {stage === "preview" && (
        <s-section heading="Preview">
          <s-paragraph>
            Review and edit the generated <s-text>llms.txt</s-text> below. When
            you’re happy with it, publish to make it live at{" "}
